...
function setValuesOnPage(forecast) {
    ...
    document.getElementById('current-temperature').innerHTML = forecast[1]['temperature'] + '&a0';
    document.getElementById('a1').innerHTML = date.toLocaleString('en', { weekday: 'long' });
    for (var i = 0; i < forecast.length - 1; i++) {
        ...
        temp[i].innerHTML = forecast[i]['temperature'] + '&a0;';
